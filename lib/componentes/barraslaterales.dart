      ...
      child: Container(
        ...
        child: ListView(
          children: <Widget>[
            ...
            SizedBox(height: 10,),
            Align(alignment: Alignment.center,child: Wrap(children: [Text('Reclutador',style: TextStyle(fontSize: 18, color: Colors.white),)],)),
            SizedBox(height: 50,),
            IconButton(onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => JefeReclutadorPrincipal()));
            }, icon: Icon(Icons.account_circle, color: Colors.white,size: 50,)),
            SizedBox(height: 10,),
            Align(alignment: Alignment.center,child: Wrap(children: [Text('Reporte de prospectos',style: TextStyle(fontSize: 18, color: Colors.white),)],)),
            SizedBox(height: 50,),
            IconButton(onPressed: ()  {
            ...
            SizedBox(height: 10,),
            Align(alignment: Alignment.center,child: Wrap(children: [Text('Reporte de Reclutador',style: TextStyle(fontSize: 18, color: Colors.white),)],)),
            SizedBox(height: 50,),
            IconButton(onPressed: ()  {
            ...
            SizedBox(height: 10,),
            Align(alignment: Alignment.center,child: Wrap(children: [Text('Borrar Reclutador',style: TextStyle(fontSize: 18, color: Colors.white),)],)),
            SizedBox(height: 50,),
            IconButton(onPressed: ()  {
              Navigator.push(context, MaterialPageRoute(builder: (context) => borrarProspecto()));
            }, icon: Icon(Icons.remove_circle, color: Colors.white,size: 50,)),
            SizedBox(height: 10,),
            Align(alignment: Alignment.center,child: Wrap(children: [Text('Borrar Prospecto',style: TextStyle(fontSize: 18, color: Colors.white),)],)),
          ],
        ),
      ),
    );
