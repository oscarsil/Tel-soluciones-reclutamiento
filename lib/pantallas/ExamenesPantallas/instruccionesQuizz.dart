...
class instruccionesQuizz extends StatefulWidget{
  ...
  instruccionesQuizz({required this.prospecto_int});
...
class _instruccionesQuizzState extends State<instruccionesQuizz> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(preferredSize: const Size.fromHeight(50),child:barraInformativa(titulo:'instrucciones para el Quizz')),
      body: Center(
        child: Column(
          children: [
